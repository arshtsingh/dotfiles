...
function fish_prompt
    ...
    switch (date)
      case '*Mar*' '*Apr*' '*May*'
        echo -en $chevrons
        echo -n (set_color cyan)'❯'(set_color green)'❯'(set_color yellow)'❯ '
      case '*Jun*' '*Jul*' '*Aug*'
        echo -en $chevrons
        echo -n (set_color 37CACE)'❯'(set_color FFFE6F)'❯'(set_color EFC2F1)'❯ '
      case '*Sep*' '*Oct*' '*Nov*'
        echo -en $chevrons
        echo -n (set_color 603C14)'❯'(set_color 9C2706)'❯'(set_color D45B12)'❯ '
      case '*Dec*' '*Jan*' '*Feb*'
        echo -en $chevrons
        echo -n (set_color ffffff)'❯'(set_color 53cdf1)'❯'(set_color 4108ff)'❯ '
    end
